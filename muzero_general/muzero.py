...
from muzero_general import trainer, replay_buffer, shared_storage, self_play, diagnose_model, models
...
class MuZero:
    ...
    def __init__(self, game_name=None, config=None, split_resources_in=1, game_cls_and_config=None):
        # Load the game and the config from the module with the game name
        if game_cls_and_config:
            [self.Game, self.config] = game_cls_and_config
        else:
            try:
