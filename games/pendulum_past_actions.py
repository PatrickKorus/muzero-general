...
class Game(AbstractGame):
    ...
    def __init__(self, seed=None):
        ...
        if seed is not None:
            self.env.seed(seed)
        # self.past_actions = numpy.zeros(5, dtype='float64')
    ...
    def step(self, action):
        ...
        reward = 16 + max(-16, reward)
        # self.past_actions = numpy.roll(self.past_actions, shift=1)
        # self.past_actions[0] = action
        return numpy.array([[observation]]), reward / 16, done
